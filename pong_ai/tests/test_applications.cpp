...
void test_pattern_classifier_portability() {
    ...
    trainer.nn_.template train<utec::neural_network::BinaryCrossEntropyLoss, utec::neural_network::Adam>(X, Y, 10, 4, 0.01f);
...
void test_sequence_predictor_functionality() {
    ...
    predictor.nn_.template train<utec::neural_network::MSELoss, utec::neural_network::Adam>(X, Y, 5000, 5, 0.005f);
